(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Sloppy5-"; // Prefix string to be prepended to the cart's name in the session storage
				...
				if( cartItems.length > 0 ) {
					...
					for( var j = 0; j < cartItems.length; ++j ) {
						...
						$.ajax({
   							method: "POST",
   							url: "orderinfo.php",
   							data: { cartItem: cartItem, cartPrice: cartPrice, cartQty:cartQty }
						})
